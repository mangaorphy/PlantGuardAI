    ...
    try {
      ...
      if (snapshot.docs.isNotEmpty) {
        ...
        _pesticides = fetchedProducts
            .where((p) => p.category == 'pesticide')
            .toList();
        _fertilizers = fetchedProducts
            .where((p) => p.category == 'fertilizer')
            .toList();
        _plants = fetchedProducts.where((p) => p.category == 'plant').toList();
        _tutorials = fetchedProducts
            .where((p) => p.category == 'tutorial')
            .toList();
        ...
        if (_products.isEmpty) {
          print('⚠️ No valid products found, creating sample data...');
          await _populateProductsCollection();
